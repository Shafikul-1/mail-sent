...
<section class="w-full overflow-hidden dark:bg-gray-900">
    <div class="flex flex-col">
        ...
        <div class="sm:w-[80%] xs:w-[90%] mx-auto flex">
            ...
            <!-- FullName -->
            <h1 class="w-full text-left my-4 sm:mx-4 xs:pl-4 text-gray-800 dark:text-white lg:text-4xl md:text-3xl sm:text-3xl xs:text-xl font-serif"> {{$singleUser['name']}} </h1>
                    ...
                    <div class="w-full">
                        <dl class="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                            ...
                            <div class="flex flex-col pt-3">
                                ...
                                <dd class="text-lg font-semibold"> {{$singleUser['phonenumber']}} </dd>
                            </div>
                            <div class="flex flex-col pt-3">
                                <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Email</dt>
                                <dd class="text-lg font-semibold"> {{$singleUser['email']}}</dd>
                            </div>
