...
@section('othersContent')
    <form method="POST" action="{{route('mailsetting.update', $editMailSettingData['id'])}}" class="max-w-sm mx-auto " >
        @csrf
        @method('PUT')
            <div class="mb-5"> 
                <label for="mail_transport" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">mail_transport</label>
                <input value="{{$editMailSettingData['mail_transport']}}" type="text" id="mail_transport" name="mail_transport" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  placeholder="Enter Your mail_transport"/>
            ...
            <div class="mb-5">
                ...
                <input value="{{$editMailSettingData['mail_host']}}" type="text" id="mail_host" name="mail_host" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Your mail_host"/>
            ...
            <div class="mb-5">
                ...
                <input value="{{$editMailSettingData['mail_port']}}" type="text" id="mail_port" name="mail_port" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Your mail_port"/>
            ...
            <div id="mail_username" class="mb-5 "> 
                ...
                <input value="{{$editMailSettingData['mail_username']}}" type="text" id="mail_username" name="mail_username" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  placeholder="Enter Your mail_username"/>
            ...
            <div id="mail_password" class="mb-5 "> 
                ...
                <input value="{{$editMailSettingData['mail_password']}}" type="text" id="mail_password" name="mail_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  placeholder="Enter Your mail_password"/>
            ...
            <div id="mail_encryption" class="mb-5 "> 
                ...
                <input value="{{$editMailSettingData['mail_encryption']}}" type="text" id="mail_encryption" name="mail_encryption" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  placeholder="Enter Your mail_encryption"/>
            ...
            <div id="mail_sender_name" class="mb-5 "> 
                ...
                <input value="{{$editMailSettingData['mail_sender_name']}}" type="text" id="mail_sender_name" name="mail_sender_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  placeholder="Enter Your mail_sender_name"/>
